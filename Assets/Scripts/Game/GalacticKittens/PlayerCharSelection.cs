...
namespace Game.GalacticKittens
{
    ...
    public class PlayerCharSelection : MonoBehaviour
    {
        ...
        [SerializeField] private int charSelected = k_noCharacterSelectedValue;
        [SerializeField] private long playerId;
        [SerializeField] private AudioClip _changedCharacterClip;


        public int CharSelected => charSelected;
        ...
        {
            return playerId != k_noCharacterSelectedValue;
        }
        ...
        // private void Update()
        // {
        //     if (IsOwner && CharacterSelectionManager.Instance.GetConnectionState(m_playerId.Value) !=
